class ContentsController < ApplicationController
	...
	param :Type, String, desc: 'Type of the content', required: true
	...
	def content_params
		params.require(:content).permit(:id, :name, :url, :type)
	end
	...
	param :Type, String, desc: 'Type of the content', required: false
	def update
